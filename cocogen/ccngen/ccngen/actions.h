...
ccn_node *DGCCattribute(ccn_node *);
ccn_node *DGDFast(ccn_node *);
ccn_node *DGDFast(ccn_node *);
ccn_node *DGDFinode(ccn_node *);
ccn_node *DGDFinode(ccn_node *);
ccn_node *DGDFchild(ccn_node *);
ccn_node *DGDFchild(ccn_node *);
ccn_node *DGDFattribute(ccn_node *);
ccn_node *DGDFattribute(ccn_node *);
struct ccn_node *DGDTid(struct ccn_node *node);
struct ccn_node *DGDTienum(struct ccn_node *node);
struct ccn_node *DGDTattribute(struct ccn_node *node);
struct ccn_node *DGDTitravdata(struct ccn_node *node);
struct ccn_node *DGDTsetoperation(struct ccn_node *node);
struct ccn_node *DGDTsetliteral(struct ccn_node *node);
struct ccn_node *DGDTsetreference(struct ccn_node *node);
struct ccn_node *DGDTste(struct ccn_node *node);
struct ccn_node *DGDTchild(struct ccn_node *node);
struct ccn_node *DGDTlifetime_range(struct ccn_node *node);
struct ccn_node *DGDTilifetime(struct ccn_node *node);
struct ccn_node *DGDTinodeset(struct ccn_node *node);
struct ccn_node *DGDTinode(struct ccn_node *node);
struct ccn_node *DGDTipass(struct ccn_node *node);
struct ccn_node *DGDTitraversal(struct ccn_node *node);
struct ccn_node *DGDTiphase(struct ccn_node *node);
struct ccn_node *DGDTiactions(struct ccn_node *node);
struct ccn_node *DGDTast(struct ccn_node *node);
