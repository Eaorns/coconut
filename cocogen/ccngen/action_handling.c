...
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENDEBUGFUNCTIONS, "dynamicGenDebugFunctions", .traversal = {TRAV_DGDF,},},
{CCN_ACTION_TRAVERSAL, CCNAC_ID_DYNAMICGENDEBUGTRAVERSAL, "dynamicGenDebugTraversal", .traversal = {TRAV_DGDT,},},
